...
class EPLSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://www.premierleague.com/tables?co=1&se=79&mw=-1&ha=-1'
    ]
    ...
    def parse(self, response):
        ...
        rows = selector.xpath('//*[@id="mainContent"]/div[2]/div[1]//table/tbody//tr[not(@class="expandable")]')
        ...
        for row in rows:
            ...
            item['gd'] = row.xpath('./td[10]/text()')[0].extract().strip()
